...
public class DivisionTest {
	...
	@Test
	public void pruebaDividirParteMultiplicando() {
		assertEquals(1, Division.dividirParteMultiplicando(Arrays.asList(1), Arrays.asList(1)));
		assertEquals(2, Division.dividirParteMultiplicando(Arrays.asList(2), Arrays.asList(1)));

		assertEquals(1, Division.dividirParteMultiplicando(Arrays.asList(5), Arrays.asList(5)));
		assertEquals(2, Division.dividirParteMultiplicando(Arrays.asList(1,0), Arrays.asList(5)));
		assertEquals(3, Division.dividirParteMultiplicando(Arrays.asList(1,5), Arrays.asList(5)));
		assertEquals(4, Division.dividirParteMultiplicando(Arrays.asList(2,0), Arrays.asList(5)));
		assertEquals(5, Division.dividirParteMultiplicando(Arrays.asList(2,5), Arrays.asList(5)));	
		assertEquals(6, Division.dividirParteMultiplicando(Arrays.asList(3,0), Arrays.asList(5)));	
		assertEquals(7, Division.dividirParteMultiplicando(Arrays.asList(3,5), Arrays.asList(5)));	
		assertEquals(8, Division.dividirParteMultiplicando(Arrays.asList(4,0), Arrays.asList(5)));	
		assertEquals(9, Division.dividirParteMultiplicando(Arrays.asList(4,5), Arrays.asList(5)));	
	}	
	...
	@Test
	public void pruebaDividirUsandoMultiplicacion() {
		
		assertEquals(Arrays.asList(1), Division.dividirUsandoMultiplicacion(Arrays.asList(1), Arrays.asList(1)));
		assertEquals(Arrays.asList(2), Division.dividirUsandoMultiplicacion(Arrays.asList(2), Arrays.asList(1)));

		assertEquals(Arrays.asList(1), Division.dividirUsandoMultiplicacion(Arrays.asList(5), Arrays.asList(5)));
		assertEquals(Arrays.asList(2), Division.dividirUsandoMultiplicacion(Arrays.asList(1,0), Arrays.asList(5)));
		assertEquals(Arrays.asList(3), Division.dividirUsandoMultiplicacion(Arrays.asList(1,5), Arrays.asList(5)));
		assertEquals(Arrays.asList(4), Division.dividirUsandoMultiplicacion(Arrays.asList(2,0), Arrays.asList(5)));
		assertEquals(Arrays.asList(5), Division.dividirUsandoMultiplicacion(Arrays.asList(2,5), Arrays.asList(5)));		
		
		assertEquals(Arrays.asList(1,1), Division.dividirUsandoMultiplicacion(Arrays.asList(5,5), Arrays.asList(5)));
		assertEquals(Arrays.asList(2,0), Division.dividirUsandoMultiplicacion(Arrays.asList(1,0,0), Arrays.asList(5)));
		assertEquals(Arrays.asList(3,0), Division.dividirUsandoMultiplicacion(Arrays.asList(1,5,0), Arrays.asList(5)));
		assertEquals(Arrays.asList(4,0), Division.dividirUsandoMultiplicacion(Arrays.asList(2,0,0), Arrays.asList(5)));
		assertEquals(Arrays.asList(5,0), Division.dividirUsandoMultiplicacion(Arrays.asList(2,5,0), Arrays.asList(5)));		

		assertEquals(Arrays.asList(1,3,1), Division.dividirUsandoMultiplicacion(Arrays.asList(1,3,1), Arrays.asList(1)));
		assertEquals(Arrays.asList(1,0), Division.dividirUsandoMultiplicacion(Arrays.asList(1,3,1), Arrays.asList(1,3)));	
		assertEquals(Arrays.asList(8), Division.dividirUsandoMultiplicacion(Arrays.asList(1,3,1), Arrays.asList(1,5)));	
	}	
